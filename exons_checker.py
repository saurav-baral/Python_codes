...
header = "Species,Exon1,Exon2,Exon3,Exon4,Exon5,Exon6,Exon7\n"
output_data = header
genome_names_file.close()
extracted_exon_files = os.listdir("C:/Users/sauba/Desktop/Work_Stuff/MRJP/Genes/3.Extracted/0.Yellow_c")
...
#    print (output_data)
#    break
output_file = open("C:/Users/sauba/Desktop/Work_Stuff/MRJP/0.for_automation_temp_files/1.Tester_files/Yellow_c_exonrecord.csv",'w')
