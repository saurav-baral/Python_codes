...
scaffold = "CP053157.1"
Species = "Carposina_sasakii"
query_exon = "Exon1"
done_species_list_temp = []
entries = os.listdir("C:/Users/sauba/Desktop/Work_Stuff/MRJP/Genes/3.Extracted/7.Yellow_h2")
for file_names  in entries :
    if query_exon in file_names and Species not in file_names:
...
#print (script2)
    ...
    #                        print(lines)
        ...
        if "Score" in lines and query_stop_coor != 0:
            break
    query_difference = int(query_length) -(int(query_stop_coor)-int(query_start_coor)-1)
        #               
...
if query_difference < 5:
    ...
    with open("C:/Users/sauba/Desktop/Work_Stuff/MRJP/Genes/3.Extracted/7.Yellow_h2/"+Species+"_"+query_exon+".fa",'w') as f:
