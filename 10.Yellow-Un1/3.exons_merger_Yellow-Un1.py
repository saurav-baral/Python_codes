...
species_list_file = open("C:/Users/sauba/Desktop/Work_Stuff/MRJP/Genes/3.Extracted/0.Temp_use_files/Yellow-Un1_species_selected.txt",'r')
species_list = species_list_file.readlines()
species_list_file.close()
frame = [1,3,3,1,2,1,1,1]
output = ''
exons_list = ["Exon1","Exon2","Exon3","Exon4","Exon5","Exon6","Exon7","Exon8"]
full_sequence = ''
