...
phylo_species = open("C:/Users/sauba/Desktop/Work_Stuff/MRJP/3.Phylo/5.phylo_21_08-31/1.species/phylo_species.txt",'r')
...
#        print(query_name, start_coor, stop_coor, query_start_coor, query_stop_coor)
        if start_coor < stop_coor:
            complement = "0"
            length = (stop_coor-start_coor+1)/3
            start = start_coor
            stop = stop_coor
...
#            print(length,query_length - 0.05*query_length )
            error = "Y"
...
#        print(translated_sequence)
    ...
    output_file = open("C:/Users/sauba/Desktop/Work_Stuff/MRJP/3.Phylo/5.phylo_21_08-31/0.Phylo_coordinates/"+species_name.split("\n")[0]+"_coordinates.csv",'w')
