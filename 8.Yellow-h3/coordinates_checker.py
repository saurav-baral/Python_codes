...
Species = "Heliconius_hermathena"
exon = "Exon1"
frame = 1
with open("C:/Users/sauba/Desktop/Work_Stuff/MRJP/0.for_automation_temp_files/8.Yellow_h3/"+Species+"_coordinates.csv",'r') as f:
    coordinates_list = f.readlines()
coordinate_line = coordinates_list[int(exon[-1])].split(",")
...
sequence_extract(species,scaffold,start,stop,complement,frame)