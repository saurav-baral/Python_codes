...
import os
import csv
#coordinate_files = os.listdir("C:/Users/sauba/Desktop/Work_Stuff/MRJP/0.for_automation_temp_files/11.Yellow_Un2")
...
#
#
coor_species = "Zygaena_filipendulae"
coordinate_files = [coor_species+"_coordinates.csv"]
errors = ''
for coordinate_file_names in coordinate_files:
    try:    
        coordinates_detail_file = open("C:/Users/sauba/Desktop/Work_Stuff/MRJP/0.for_automation_temp_files/11.Yellow_Un2/"+coordinate_file_names,'r')
...
#            print(scaffold, reverse_c)
#            print("bbbb",scaffold, old_scaffold)
#            if scaffold != old_scaffold:
#                print(scaffold, "not equal", old_scaffold)
            if scaffold != old_scaffold:
...
#                print(out_Seq)
            ...
            out_file = open(("C:/Users/sauba/Desktop/Work_Stuff/MRJP/Genes/3.Extracted/11.Yellow_Un2/"+Species+"_"+exon+".fa"),'w')
            output_sequence = ">"+Species+"_"+scaffold+"_"+exon+"_"+str(start)+"-"+str(end)+"\n"+str(out_Seq)+"\n"
