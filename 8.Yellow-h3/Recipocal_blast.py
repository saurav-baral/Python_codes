...
for species_name in species_list:
    try:
        ...
        for i in range(len(exon_names)):
            exon = exon_names[i]
            with open("C:/Users/sauba/Desktop/Work_Stuff/MRJP/Genes/3.Extracted/8.Yellow_h3/"+exon.split("Exon")[1]+"."+exon+"/"+Species+"_"+exon+".fa",'r') as f:
        ...
        with open("C:/Users/sauba/Desktop/Work_Stuff/MRJP/0.for_automation_temp_files/00.Temp/0.recipocal_blast_yellow_h3/"+Species+"_"+gene+"_recipocal_blast.txt", "w") as f:
            f.write(result_handle.read())
        result_handle.close()
    except Exception:
        errors = errors+(("\nThe error species is "+ Species))
        print(("\nThe error species is "+ Species))
with open("C:/Users/sauba/Desktop/Work_Stuff/MRJP/0.for_automation_temp_files/00.Temp/0.recipocal_blast_yellow_h3/00.errors.txt", "w") as error_file:
