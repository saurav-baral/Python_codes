def sequence_maker(query_exon, last_exon, Species, scaffold, complement, start, stop, query_start_coor, query_stop_coor, seq_length, start_modifier, stop_modifier,query_length,query_difference,frame, scaff_area, scaffold_name, start_area):
