...
for species_name in species_list:
    ...
    #        print(translated_sequence)
        ...
        output_file = open("C:/Users/sauba/Desktop/Work_Stuff/MRJP/0.for_automation_temp_files/11.Yellow_Un2/"+species_name.split("\n")[0]+"_coordinates.csv",'w')
