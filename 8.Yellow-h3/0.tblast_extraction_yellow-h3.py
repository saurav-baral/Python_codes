...
#print(species_list)
query_name_list = ["Exon1","Exon2","Exon3"]
species_without_exon1 = ["Helicoverpa_armigera","Pieris_rapae"]
#query_length_list = [144,40,75,38,27,37,47]
seq_modi = [[0,2],[1,1],[2,0]]
    ...
    #        query_length = query_length_list[i]
            ...
            for lines in lines_in_file:
                if query_name in lines:
                    ...
                    query_species = lines.split(" ")[1][6:-1]
                    print(query_species)
...
#                    print(species_name.split("\n")[0], scaff, int(complement), start, stop,frame, query_name )
                    if translated_sequence == old_trans:
                        break
                    if query_name == "Exon1" and query_species not in species_without_exon1:
...
#                            print(start, stop)
    ...
    #        print(translated_sequence)
        ...
        output_file = open("C:/Users/sauba/Desktop/Work_Stuff/MRJP/0.for_automation_temp_files/8.Yellow_h3/"+species_name.split("\n")[0]+"_coordinates.csv",'w')
