...
extracted_exon_files = os.listdir("C:/Users/sauba/Desktop/Work_Stuff/MRJP/Genes/3.Extracted/10.Yellow_Un1")
print(extracted_exon_files)
query_name_list = ["Exon1","Exon2","Exon3","Exon4","Exon5","Exon6","Exon7","Exon8"]
...
#    print (output_data)
#    break
output_file = open("C:/Users/sauba/Desktop/Work_Stuff/MRJP/0.for_automation_temp_files/1.Tester_files/Yellow_Un1_exonrecord.csv",'w')
