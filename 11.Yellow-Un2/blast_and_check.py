...
def blast_and_check(gene,gene_folder, done_species_list, query_exon, frame, Species,scaffold, diff_number, start_area ):
    import os
    import subprocess
...
#        query_file = open("C:/Users/sauba/Desktop/Work_Stuff/MRJP/Genes/3.Extracted/"+gene_folder+"/"+query_species+"_"+query_exon+".fa",'r')                                 #take the species exon as query file
        ...
        print(f"Length of query: {query_length}, Query_start = {query_start_coor}, Query_stop = {query_stop_coor}, {query_difference}, scaf_start = {start_coor+start_area}, scaf_end = {stop_coor+start_area}")
