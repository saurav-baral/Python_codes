...
import os
import csv
coordinate_files = os.listdir("C:/Users/sauba/Desktop/Work_Stuff/MRJP/0.for_automation_temp_files/12.Yellow_Un3")
...
for coordinate_file_names in coordinate_files:
    try:    
        coordinates_detail_file = open("C:/Users/sauba/Desktop/Work_Stuff/MRJP/0.for_automation_temp_files/12.Yellow_Un3/"+coordinate_file_names,'r')
...
#                print(out_Seq)
            ...
            out_file = open(("C:/Users/sauba/Desktop/Work_Stuff/MRJP/Genes/3.Extracted/12.Yellow_Un3/"+Species+"_"+exon+".fa"),'w')
