...
import os
import csv
#coordinate_files = os.listdir("C:/Users/sauba/Desktop/Work_Stuff/MRJP/0.for_automation_temp_files/0.Yellow_c")
coordinate_files = ["Conopomorpha_cramerella_coordinates.csv"]
errors = ''
for coordinate_file_names in coordinate_files:
    try:    
        coordinates_detail_file = open("C:/Users/sauba/Desktop/Work_Stuff/MRJP/0.for_automation_temp_files/0.Yellow_c/"+coordinate_file_names,'r')
...
#                    print ("\n\n"+out_trans.translate()) 
                ...
                #    break
                fasta_file.close()
                out_file = open(("C:/Users/sauba/Desktop/Work_Stuff/MRJP/Genes/3.Extracted/0.Yellow_c/"+Species+"_"+exon+".fa"),'w')
