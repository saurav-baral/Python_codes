...
for species_name in species_list:
    try:
        ...
        with open("C:/Users/sauba/Desktop/Work_Stuff/MRJP/0.for_automation_temp_files/00.Temp/0.recipocal_blast/"+Species+"_"+gene+"_recipocal_blast.txt", "w") as f:
            f.write(result_handle.read())
        result_handle.close()
    except Exception:
        errors = errors+(("\nThe error species is "+ Species))
        print(("\nThe error species is "+ Species))
with open("C:/Users/sauba/Desktop/Work_Stuff/MRJP/0.for_automation_temp_files/00.Temp/0.recipocal_blast/00.errors.txt", "w") as error_file:
