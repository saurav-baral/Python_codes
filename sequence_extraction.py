...
for file_names  in entries:
    if ".nhr" in file_names:
        ...
        break
#print(genome_name)
#Genome_name = "0.for_yellow_f3/OU342670.1.fna"
Scaff = "NC_004354.4"
...
#fasta_file = open(str("C:/Users/sauba/Desktop/Work_Stuff/3.Genomes/data/"+Species+"/0.for_yellow_f3/CADEBD010000330.1.fna"),'r')
