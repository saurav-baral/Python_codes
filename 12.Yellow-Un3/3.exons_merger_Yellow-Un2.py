...
for i in range(len(species_list)):
    ...
    for j in range(len(exons_list)):
        exon = exons_list[j]
        file_name = "C:/Users/sauba/Desktop/Work_Stuff/MRJP/Genes/3.Extracted/11.Yellow_Un2/"+str(j+1)+"."+exon+"/"+species+"_"+exon+".fa"
...
#            print(records.seq)
    ...
    if "*" in Seq(full_sequence).translate()[:-1]:
        ...
        input("Continue?")
    output = output + ">"+species+"_Yellow_Un2\n"+full_sequence+"\n\n"
    print(">"+species+"_Yellow_Un1\n"+full_sequence+"\n\n")
output_file = open("C:/Users/sauba/Desktop/Work_Stuff/MRJP/Genes/3.Extracted/11.Yellow_Un2/Yellow_Un2.fa",'w')
