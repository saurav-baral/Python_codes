...
import os
import csv
coordinate_files = os.listdir("C:/Users/sauba/Desktop/Work_Stuff/MRJP/3.Phylo/5.phylo_21_08-31/0.Phylo_coordinates")
for coordinate_file_names in coordinate_files:
        
    coordinates_detail_file = open("C:/Users/sauba/Desktop/Work_Stuff/MRJP/3.Phylo/5.phylo_21_08-31/0.Phylo_coordinates/"+coordinate_file_names,'r')
    ...
    #        
            ...
            #    break
            fasta_file.close()
            out_file = open(("C:/Users/sauba/Desktop/Work_Stuff/MRJP/3.Phylo/5.phylo_21_08-31/2.Extracted/"+Species+"_"+exon+".fa"),'w')
