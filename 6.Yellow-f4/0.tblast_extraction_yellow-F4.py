...
seq_modi = [[0,1],[2,1],[2,1],[2,1],[2,1],[2,0],[0,1],[2,2],[1,0]]
...
for species_name in species_list:
    ...
    #        print(translated_sequence)
        ...
        output_file = open("C:/Users/sauba/Desktop/Work_Stuff/MRJP/0.for_automation_temp_files/6.Yellow_f4/"+species_name.split("\n")[0]+"_coordinates.csv",'w')
