...
header = "Species,Exon1,Exon2,Exon3\n"
output_data = header
genome_names_file.close()
extracted_exon_files = os.listdir("C:/Users/sauba/Desktop/Work_Stuff/MRJP/Genes/3.Extracted/8.Yellow_h3")
...
#    print (output_data)
#    break
output_file = open("C:/Users/sauba/Desktop/Work_Stuff/MRJP/0.for_automation_temp_files/1.Tester_files/Yellow_h3_exonrecord.csv",'w')
